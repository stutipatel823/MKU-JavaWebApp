...
public class UserService {
     ...
     */
    public void registerUser(String firstname, String lastname, String email, String password, String confirmPassword) throws SQLException {
        ...
        User_CRUD.createUser(firstname, lastname, email, password, confirmPassword);
    }
