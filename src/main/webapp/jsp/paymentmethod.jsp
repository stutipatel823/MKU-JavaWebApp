...
<body>
    <div class="container">
        ...
        <div class="menu-container">
            <h2 class="title">Your Payment Method</h2>
            ...
            <form action="<%= request.getContextPath() %>/paymentMethod" method="post">
                ...
                <div id="cardFields" style="display: <% if (isUpdate && !paymentInfo.getPaymentMethod().equals("PayPal")) { %>block<% } else { %>none<% } %>;">
                    ...
                    <input type="text" placeholder="1234567890" name="cardNumber" class="form-input" id="cardNumber"
                           <% if (isUpdate && !paymentInfo.getPaymentMethod().equals("PayPal")) { %>value="<%= paymentInfo.getCardNumber() %>"<% } %> required>
                ...
                <!-- Submit Button -->
                <button type="submit" class="btn" style="background-color:pink;"><%= isUpdate ? "Update" : "Add" %> Payment Method</button>
            </form>
        </div>
    </div>
</body>
