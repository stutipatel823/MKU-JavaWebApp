package com.mku.order.persistence;
...
//    private static final String DB_URL = "jdbc:mysql://localhost:3306/Order_MKU";
    ...
    private static Connection getConnection() throws SQLException {
        ...
        String DB_URL = "jdbc:mysql://" + connection + "/Order_MKU";
    ...
    public static int insertOrder(int userId, int cartId, int paymentId, double totalAmount, List<ProductInfo> cartProducts) throws SQLException {
        ...
        try (Connection conn = getConnection();
            ...
            String paymentStatus = "Shipped";
            orderStmt.setDouble(1, totalAmount);
            orderStmt.setString(2, paymentStatus);
